package com.testmavengit.spring;
...
@Configuration
@ComponentScan({ "com.testmavengit" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.testmavengit");
                servletContext.setInitParameter("tapestry.development-modules", "com.testmavengit.services.DevelopmentModule");
